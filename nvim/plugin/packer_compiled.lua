...
_G.packer_plugins = {
  ...
  dracula = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/dracula",
    url = "https://github.com/Mofiqul/dracula.nvim"
  },
  embark = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/embark",
  ...
  nord = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/nord",
